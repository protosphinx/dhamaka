...
//   1. LanguageModel       — Chrome Prompt API / Gemini Nano (resident, free, fastest when present)
...
export function createEngine(options = {}) {
  ...
  // auto: prefer LanguageModel/window.ai → transformers → wasm → mock.
  //
  // The browser Prompt API is the fastest when present (shared with the
  //   browser, GPU-accelerated), but Chrome-only at the moment.
